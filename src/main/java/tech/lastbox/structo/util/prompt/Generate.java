    ...
    STRUCTURE {
        ...
        public String generate(String description, String history, String baseInfo) {
            return (String.format("""
                    You are a software architect assistant. Given a project description and its structure, generate a list of diagrams in JSON format. Each diagram should be represented in Mermaid syntax. Do not include any explanatory messages before or after the JSON output.
